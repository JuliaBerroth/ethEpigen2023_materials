...
```{r, eval=FALSE}
#eval=FALSE makes that it won't rerun the download everytime when to knit, but it is still there if you run it once
options(timeout=3600) #we need to increase the download timeout since the file is large & cnx slow
dir.create("raw")
...
# source("peaks/Myc_model.r") --> skipping it for the moment
```
